...
static FunctionMap FMAP [] = {
  ...
  { { "bookmarks",             "Bookmarks",                         }, (Func)dwb_com_bookmarks,           "No Bookmarks",                    NeverSM,     { .n = OpenNormal }, }, 
  { { "bookmarks_nv",          "Bookmarks new view",                }, (Func)dwb_com_bookmarks,           "No Bookmarks",                    NeverSM,     { .n = OpenNewView }, },
  { { "bookmarks_nw",          "Bookmarks new window",              }, (Func)dwb_com_bookmarks,           "No Bookmarks",                    NeverSM,     { .n = OpenNewWindow}, }, 
  { { "new_view",              "New view for next navigation",      }, (Func)dwb_com_new_window_or_view,  NULL,                              NeverSM,     { .n = OpenNewView}, }, 
  { { "new_window",            "New window for next navigation",    }, (Func)dwb_com_new_window_or_view,  NULL,                              NeverSM,     { .n = OpenNewWindow}, }, 
  ...
  { { "toggle_encoding",       "Toggle Custom encoding",            }, (Func)dwb_com_toggle_custom_encoding,    NULL,                        PostSM, },
  ...
  { { "file_access_from_file_uris",     "Toggle file access from file uris",   }, (Func)dwb_com_toggle_property,     NULL,                  PostSM, { .p = "enable-file-acces-from-file-uris" } },
  { { "universal file_access_from_file_uris",   "Toggle universal file access from file uris",   }, (Func)dwb_com_toggle_property,  NULL,   PostSM, { .p = "enable-universal-file-acces-from-file-uris" } },
...
static WebSettings DWB_SETTINGS[] = {
  ...
  { { "default-encoding",			                   "Default encoding", },                                        true, false,  Char,    { .p = "utf-8"      }, (S_Func) dwb_webkit_setting, },
  ...
  { { "custom-encoding",                         "Custom encoding", },                                         false, false, Char,    { .p = "utf-8"           }, (S_Func) dwb_webview_property, },
