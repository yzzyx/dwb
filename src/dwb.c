...
static FunctionMap FMAP [] = {
  ...
  { { "allow_cookie",          "Cookie allowed",                    }, 0, (Func)dwb_com_allow_cookie,        "No new domain in current context",    POST_SM, },
  ...
  { { "focus_next",            "Focus next view",                   }, 0, (Func)dwb_com_focus,              "No other view",                   ALWAYS_SM,  { .n = 1 } },
  { { "focus_prev",            "Focus previous view",               }, 0, (Func)dwb_com_focus,              "No other view",                   ALWAYS_SM,  { .n = -1 } },
...
static WebSettings DWB_SETTINGS[] = {
  ...
  { { "background-tabs",			                     "Open tabs in background", },                                 false, true,  BOOLEAN,    { .b = false         }, (S_Func) dwb_set_background_tab, },
...
dwb_load_uri(GList *gl, Arg *arg) {
  ...
  if (dwb.state.type == HTML_STRING) {
    webkit_web_view_load_string(web, arg->p, NULL, NULL, "about:blank");
    dwb.state.type = 0;
    return;
  }
