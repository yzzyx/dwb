...
static FunctionMap FMAP [] = {
  ...
  { { "allow_session_cookie_tmp",          "Cookie allowed",                    }, 1, 
    (Func)commands_allow_cookie,        "No new domain in current context",   ALWAYS_SM, { .n = COOKIE_ALLOW_SESSION_TMP } },
  ...
  { { "entry_delete_line",      "Command line: Delete to beginning of the line", },  0,  
    (Func)commands_entry_movement,            NULL,        ALWAYS_SM,  { .n = GTK_MOVEMENT_BUFFER_ENDS, .i = -1, .b = true }, true, }, 
  ...
  { { "entry_word_forward",     "Command line: Move cursor forward on word", },      0,  
    (Func)commands_entry_movement,           NULL,        ALWAYS_SM,  { .n = GTK_MOVEMENT_WORDS, .i = 1, .b = false }, true, }, 
