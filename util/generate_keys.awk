...
END {
  print "<tr class='dwb_table_row'><th class='dwb_table_headline' colspan='3'>Custom keys</th></tr>"
	print "<td colspan='3'><div class='desc'>Custom keys can be defined in the following form:"
